...
class TimNghichDaoScreen extends StatefulWidget {
  const TimNghichDaoScreen({Key? key}) : super(key: key);
...
class _NhanBinhPhuongCoLapScreenState extends State<TimNghichDaoScreen> {
  TimNghichDaoViewModel viewModel = TimNghichDaoViewModel();
